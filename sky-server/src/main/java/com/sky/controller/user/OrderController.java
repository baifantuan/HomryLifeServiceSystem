...
public class OrderController {
     ...
     */
    @PostMapping("/submit")
    @ApiOperation("提交下单信息接口")
    public Result<OrderSubmitVO> submitOrder(@RequestBody OrdersSubmitDTO ordersSubmitDTO) {
        log.info("提交的订单信息为:{}", ordersSubmitDTO);
    ...
    @ApiOperation("催单接口")
    public Result<String> remind(@PathVariable("id") Long id) {
        log.info("用户id:{}催单", id);
    ...
    @ApiOperation("取消订单")
    public Result<String> userCancelOrder(@PathVariable("id") Long id) {
        log.info("取消了id为{}的订单", id);
    ...
    @ApiOperation("再来一单")
    public Result<String> repetitionOrder(@PathVariable("id") Long id) {
